      ...
      <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div class="title text-center">
          <h2 class="text-3xl font-bold leading-tight text-gray-900 sm:text-4xl xl:text-5xl font-pj">
             Powerful Features for Smart Online Examinations
          </h2>
          <p class="mt-4 text-base leading-7 text-gray-600 sm:mt-8 font-pj">
             Kingohub provides everything needed to create, manage, and analyze
            online exams efficiently.
          </p>
        </div>
        ...
        <div class="grid grid-cols-1 mt-10 text-center sm:mt-16 sm:grid-cols-2 sm:gap-x-12 gap-y-12 md:grid-cols-3 md:gap-0 xl:mt-24">
          <div class="feture md:p-8 lg:p-14">
            <svg
              class="mx-auto font-[#8E7CDA]"
              width="46"
              height="46"
              viewBox="0 0 46 46"
              fill="none"
            ...
            <p class="mt-5 text-base text-gray-600 font-pj">
               Easily create and manage online examinations with flexible
              question types, time limits, and eligibility settings from a
              simple dashboard.
            </p>
          </div>

          <div class=" feture md:p-8 lg:p-14 md:border-l md:border-gray-200">
            <svg
              class="mx-auto"
              width="46"
              height="46"
            ...
            <h3 class="mt-12 text-xl font-bold text-gray-900 font-pj">Performance Analytics</h3>
            <p class="mt-5 text-base text-gray-600 font-pj">
              Visualize student performance with interactive charts and
              analytics. Compare results and identify top performers instantly.
            </p>
          </div>
          ...
          <div class=" feture md:p-8 lg:p-14 md:border-l md:border-gray-200">
            ...
            <p class="mt-5 text-base text-gray-600 font-pj">
                 Students can easily enroll in exams and attempt them through
              a simple and user-friendly interface designed for smooth navigation.
            </p>
          </div>

          <div class=" feture md:p-8 lg:p-14 md:border-t md:border-gray-200">
            <svg
              class="mx-auto"
              width="42"
              height="42"
            ...
            <p class="mt-5 text-base text-gray-600 font-pj">
              Create exams within minutes by adding questions, assigning marks,
              and configuring exam duration with complete flexibility.
            </p>
          </div>

          <div class=" feture md:p-8 lg:p-14 md:border-l md:border-gray-200 md:border-t">
            <svg
              class="mx-auto"
              width="46"
              height="42"
            ...
            <p class="mt-5 text-base text-gray-600 font-pj">
             Maintain fairness with secure exam access, eligibility checks,
              and controlled exam timing for every student.
            </p>
          </div>
          ...
          <div class=" feture md:p-8 lg:p-14 md:border-l md:border-gray-200 md:border-t">
            ...
            <p class="mt-5 text-base text-gray-600 font-pj">
             Automatically generate results after exams and view detailed
              score summaries, rankings, and performance insights instantly.
            </p>
          </div>
        </div>
      </div>
